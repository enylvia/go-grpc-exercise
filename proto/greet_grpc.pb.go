...
type GreetServiceClient interface {
	...
	SayHelloServerStreaming(ctx context.Context, in *NameLists, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamingClient, error)
	SayHelloClientStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloClientStreamingClient, error)
	SayHelloBirdStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBirdStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloServerStreaming(ctx context.Context, in *NameLists, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamingClient, error) {
...
func (c *greetServiceClient) SayHelloBirdStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBirdStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBirdStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBirdStreamingClient{stream}
	return x, nil
}

type GreetService_SayHelloBirdStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBirdStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBirdStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBirdStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloServerStreaming(*NameLists, GreetService_SayHelloServerStreamingServer) error
	SayHelloClientStreaming(GreetService_SayHelloClientStreamingServer) error
	SayHelloBirdStreaming(GreetService_SayHelloBirdStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloServerStreaming(*NameLists, GreetService_SayHelloServerStreamingServer) error {
...
func (UnimplementedGreetServiceServer) SayHelloBirdStreaming(GreetService_SayHelloBirdStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBirdStreaming not implemented")
}
...
func _GreetService_SayHelloBirdStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBirdStreaming(&greetServiceSayHelloBirdStreamingServer{stream})
}

type GreetService_SayHelloBirdStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBirdStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBirdStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBirdStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBirdStreaming",
			Handler:       _GreetService_SayHelloBirdStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
