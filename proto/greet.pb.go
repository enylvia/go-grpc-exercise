...
func (x *NameLists) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NameLists) ProtoMessage() {}

func (x *NameLists) ProtoReflect() protoreflect.Message {
	mi := &file_proto_greet_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NameLists.ProtoReflect.Descriptor instead.
func (*NameLists) Descriptor() ([]byte, []int) {
	return file_proto_greet_proto_rawDescGZIP(), []int{3}
}

func (x *NameLists) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x4e, 0x61, 0x6d, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x61, 0x6d,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22,
	0x27, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x18,
	0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xd3, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x65,
	0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x40, 0x0a, 0x08, 0x53, 0x61, 0x79,
	...
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x53, 0x0a, 0x17, 0x53,
	0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x12, 0x18, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x5f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4e, 0x61, 0x6d, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x73,
	...
	0x4c, 0x69, 0x73, 0x74, 0x28, 0x01, 0x12, 0x56, 0x0a, 0x15, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x42, 0x69, 0x72, 0x64, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x12,
...
var file_proto_greet_proto_goTypes = []interface{}{
	...
	(*NameLists)(nil),     // 3: greet_service.NameLists
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	3, // 1: greet_service.GreetService.SayHelloServerStreaming:input_type -> greet_service.NameLists
	1, // 2: greet_service.GreetService.SayHelloClientStreaming:input_type -> greet_service.HelloRequest
	1, // 3: greet_service.GreetService.SayHelloBirdStreaming:input_type -> greet_service.HelloRequest
	...
	2, // 7: greet_service.GreetService.SayHelloBirdStreaming:output_type -> greet_service.HelloResponse
